                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropleft">
                                        ...
                                        <div class="dropdown-menu"> <a href="{{url('/view-Market-order-details/'.$value->id)}}" class="dropdown-item">view</a>
                                            @if($value->status==0)
                                                <a href="{{url('/confirm-market-delivery/'.$value->id)}}" class="dropdown-item">Confirm</a>
                                            @endif
                                        </div>
                                    </div>
                                </td>
