                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        ...
                        <span class="crumbs-spacer"><i class="fa fa-angle-double-right"></i></span>
                            <span class="current">Tk. {!! $min !!} - {!! $max !!}</span>
                        <h2 class="entry-title">Search Products</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <div id="{{$category->slug}}" class="panel-collapse collapse">
                                        <ul class="listSidebar">
                                            @foreach($category->NavigationSubCategory as $subCategory)
                                                <li><a class="{{Request::is('category/'.$category->slug.'/'.$subCategory->slug)?'pr-all':''}}"  href="{{url('category/'.$category->slug.'/'.$subCategory->slug)}}">{{$subCategory->title}}</a></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </li>
                        ...
                        <div class="widget-info color-filter clearfix">
                            <ul class="product-cat">
                                @foreach($allBrands as $allBrand)
                                    <li><a class="{{Request::is('brand/'. $allBrand->slug) ? 'pr-all':''}}" href="{{url('/brand/'.$allBrand->slug)}}">{{$allBrand->brand_name}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="widget-ct widget-banner">
                        <div class="widget-info widget-banner-img">
                            <a href="#"><img src="{!! asset('assets/') !!}/img/banner-left.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="shop-content" style="width: 100%">
                        ...
                        <div class="tab-content">
                            <div id="grid-view" class="tab-pane active">
                                @foreach($searchProducts as $allProduct)
                ...
                <div class="product-info row">
                    ...
                    <div class="col-md-8 col-sm-6 col-xs-12">
                        <div class="info-panel">
                            ...
                            <div class="price-ratting">
                                <div class="price float-left">
                                    @if($product->offer_price)
                                        <span class="price">৳. {!! $product->offer_price !!} <del>৳. {!! $product->price !!}</del></span>
                                    @else
                            ...
                            <div class="quantity-cart">
                                <a href="{!! url('product/carts', $product->slug) !!}" class="btn btn-common"><i class="icon-basket-loaded"></i> add to cart</a>
                            </div>
